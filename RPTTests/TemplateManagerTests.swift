...
final class TemplateManagerTests: XCTestCase {
    ...
    func testTemplateDetailStatusSummary_asksNamedEmptyBlockingWorkoutToAddAnExercise() throws {
        ...
        XCTAssertEqual(
            ...
            "Ready to start with 1 exercise. You already have “Upper A” draft in progress: Started just now • No exercises added yet. Add an exercise to “Upper A” to keep going, use Save “Upper A” for Later, or discard it before starting Template “Push Day”."
        )
    }
    ...
    func testTemplateDetailStatusSummary_keepsLegacyCurrentWorkoutPlaceholderGenericForEmptyBlockingWorkout() throws {
        ...
        XCTAssertEqual(
            ...
            "Ready to start with 1 exercise. You already have a workout draft in progress: Started just now • No exercises added yet. Add an exercise to keep going, use Save for Later, or discard it before starting Template “Push Day”."
        )
    }
    ...
    func testTemplateDetailStatusSummary_keepsContinueLanguageForBlockingWorkoutWithLoggedSets() throws {
        ...
        XCTAssertEqual(
            ...
            "Ready to start with 1 exercise. You already have “Upper A” in progress: Started just now • 1 exercise • 1 set • Exercise started. Continue “Upper A”, use Save “Upper A” for Later, or discard it before starting Template “Push Day”."
        )
    }
    ...
    func testTemplateDetailStatusSummary_keepsOpenLanguageForPlannedBlockingWorkout() throws {
        ...
        XCTAssertEqual(
            ...
            "Ready to start with 1 exercise. You already have “Upper A” draft in progress: Started just now • 1 exercise • 1 set • Exercise not started yet. Open “Upper A”, use Save “Upper A” for Later, or discard it before starting Template “Push Day”."
        )
    }
    ...
    func testTemplateDetailStatusSummary_namesPartialTemplateInBlockingWorkoutGuidance() throws {
        ...
        XCTAssertEqual(
            ...
            "Starts with 1 of 2 exercises right now. 1 missing from your library • You already have “Upper A” draft in progress: Started just now • 1 exercise • 1 set • Exercise not started yet. Open “Upper A”, use Save “Upper A” for Later, or discard it before starting the available part of Template “Push Day”."
        )
    }
