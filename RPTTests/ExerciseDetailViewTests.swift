...
final class ExerciseDetailViewTests: XCTestCase {
    ...
    func testDiscardCurrentWorkoutAndStartFollowUpAlertCopy_namesSpecificCurrentWorkoutWhenAvailable() {
        ...
        XCTAssertEqual(
            ExerciseDetailView.discardCurrentWorkoutAndStartFollowUpAlertTitle(for: workout, currentWorkout: currentWorkout),
            "Discard “Push Day” & Start Follow-Up from “Upper A”?"
        )
        XCTAssertEqual(
            ExerciseDetailView.discardCurrentWorkoutAndStartFollowUpAlertMessage(for: workout, currentWorkout: currentWorkout),
