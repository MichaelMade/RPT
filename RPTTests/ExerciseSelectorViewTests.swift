...
final class ExerciseSelectorViewTests: XCTestCase {
    func testWorkoutSelectorUsesWorkoutSpecificContextCopy() {
        ...
        XCTAssertEqual(
            ...
            "Search workout exercises, notes, body regions, muscle groups, or actions"
        )
    }
    ...
    func testTemplateSelectorUsesTemplateSpecificContextCopy() {
        ...
        XCTAssertEqual(
            ...
            "Search template exercises, notes, body regions, muscle groups, or actions"
        )
    }
    ...
    func testExerciseLibraryUsesExpandedSearchPrompt() {
        XCTAssertEqual(
            ...
            "Search exercises, notes, body regions, muscle groups, or actions"
        )
    }
}
