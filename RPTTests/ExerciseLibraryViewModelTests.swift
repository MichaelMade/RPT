...
final class ExerciseLibraryViewModelTests: XCTestCase {
    ...
    func testSelectionEmptyStateDescription_teachesRicherSearchRecoveryInPickers() {
        ...
        XCTAssertEqual(
            ...
            "No exercises matched “squat”. Try a different search, clear it to browse every exercise in your library, or search names, notes, instruction cues like drive elbows back, body regions like upper body or legs, muscle groups, movement types like compound or bodyweight, and action wording like add, use, choose, or review. You can also add a custom exercise from this search.",
    ...
    func testEmptyStateKind_usesNoMatchingResultsWhenLibraryHasExercisesButFiltersHideThem() {
        ...
        XCTAssertEqual(
            viewModel.emptyStateDescription(filteredCount: 0),
            "No exercises matched “squat”. Try a different search, clear it to browse every exercise, or search names, notes, instruction cues like drive elbows back, body regions like upper body or legs, muscle groups, movement types like compound or bodyweight, and action wording like add, use, choose, or review. You can also add a custom exercise from this search."
        )
    }

    func testSearchPrompt_mentionsMovementTypesAcrossContexts() {
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ExerciseLibraryViewModel.SelectionContext.workout.searchPrompt,
            "Search workout exercises, notes, instruction cues, body regions, muscle groups, movement types, or actions"
        )
        XCTAssertEqual(
            ExerciseLibraryViewModel.SelectionContext.template.searchPrompt,
