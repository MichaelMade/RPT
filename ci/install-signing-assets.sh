...
: "${IOS_CI_KEYCHAIN_PASSWORD:?Missing CI keychain password}"
...
security set-key-partition-list -S apple-tool:,apple:,codesign: -s -k "$IOS_CI_KEYCHAIN_PASSWORD" "$KEYCHAIN_PATH"
