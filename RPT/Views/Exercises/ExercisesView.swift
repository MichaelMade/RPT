...
struct ExercisesView: View {
    static let searchPrompt = ExerciseLibraryViewModel.searchPrompt()
    ...
    @State private var exerciseDeletionImpact = ExerciseManager.DeletionImpact(loggedSetCount: 0, loggedWorkingSetCount: 0, loggedWarmupSetCount: 0, loggedWorkoutCount: 0, draftSetCount: 0, draftWorkoutCount: 0, templateCount: 0)
